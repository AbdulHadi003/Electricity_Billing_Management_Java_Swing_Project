...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype,String meter){
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/details.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/refresh.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/information.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/pay.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/detail.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("icon/bill.png"));
